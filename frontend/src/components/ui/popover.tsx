/**
 * `<Popover>` — shadcn-style wrapper over Radix `Popover`. Pulled
 * in for the `<HelpHint>` component (and any future surfaces that
 * need lightweight click-to-open floaters with multi-line
 * content). Mirrors the style of [`./tooltip.tsx`] /
 * [`./dropdown-menu.tsx`] so the look-and-feel stays consistent.
 */
