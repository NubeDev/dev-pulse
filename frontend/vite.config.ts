  ...
  server: {
    ...
    proxy: useMocks
      ...
      : {
          ...
          // Product & Manufacturing surfaces (DOCS/ideas/product-manufacturing.md).
          "/products": "http://localhost:8731",
          "/manufacturers": "http://localhost:8731",
          "/suppliers": "http://localhost:8731",
